...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Data used in this example was obtained from the urban flux tower of:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Central Arizona-Phoenix
% Long-Term Ecological Research (CAP LTER)
% which is a unit of the Julie Ann Wrigley Global Institute of Sustainability
% Arizona State University
%
% https://sustainability.asu.edu/caplter/research/long-term-monitoring/urban-flux-tower/
%
% or
%
% https://portal.edirepository.org/nis/mapbrowse?scope=knb-lter-cap&identifier=591
% 
% Citation
% Chow W. 2017. Eddy covariance data measured at the CAP LTER flux tower located 
% in the west Phoenix, AZ neighborhood of Maryvale from 2011-12-16 through 2012-12-31. 
% Environmental Data Initiative. https://doi.org/10.6073/pasta/fed17d67583eda16c439216ca40b0669. 
% Dataset accessed 8/30/2019.
%
% Publication
% Chow, W. T., T. J. Volo, E. R. Vivoni, G. D. Jenerette and B. L. Ruddell. 2014. 
% Seasonal dynamics of a suburban energy balance in Phoenix, Arizona. 
% International Journal of Climatology 34(15):3863-3880. DOI: 10.1002/joc.3947.
%
% If you plan to use the data, please download from ASU website or contact
% ASU and the corresponding author
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%% RUN TIME SERIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Load input parameters
load(fullfile('+data_functions', 'Forcing_Data_Phoenix.mat'))

% Assign calculation length
n			=	9144;		% Calculation lenght, e.g. data time series length
m			=	1;			% Usually 1 or length of sensitivity analysis vector

% Assign file names
Name_Site	=	'Arizona';	% Name chosen for "data_functions\Data_UEHM_site_Name.m" 
							% and "data_functions\UEHMForcingData_Name.m"
NameOutput	=	'Arizona90';% Name under which the calculation will be saved
