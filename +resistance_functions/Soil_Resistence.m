...
function[r_soil,b_soil,alp_soil]=Soil_Resistence(Ts,Pre,Ws,ea,q_runon,O,Ks,Osat,Ohy,L,Pe,O33,alpVG,nVG,SPAR)
%%%INPUTS
...
%%%%%%%%%
[Ko,Po]=soil_functions.Conductivity_Suction(SPAR,Ks,Osat,Ohy,L,Pe,O33,alpVG,nVG,O) ;
Po(Po<0)=0; %% [mm]
