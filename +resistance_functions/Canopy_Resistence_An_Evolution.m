...
if Fsun > 0
    ...
    %%%
    [Ci_sun]=fzero(@resistance_functions.CO2_Concentration,Citm1_sun,Opt_CR,PAR_sun,Ca,ra,rb_sun,Ts,Pre,Ds,...
    ...
    %%%%
    [CiF_sun,An_sun,rc_sun,Rdark_sun,SIF_sun]= resistance_functions.photosynthesis_biochemical(Ci_sun,PAR_sun,Ca,ra,rb_sun,Ts,Pre,Ds,...
        Psi_L,Psi_sto_50,Psi_sto_99,...
...
if Fshd > 0
    ...
    %%%%
    [Ci_shd]=fzero(@resistance_functions.CO2_Concentration,Citm1_shd,Opt_CR,PAR_shd,Ca,ra,rb_shd,Ts,Pre,Ds,...
    ...
    %%%
    [CiF_shd,An_shd,rc_shd,Rdark_shd,SIF_shd]= resistance_functions.photosynthesis_biochemical(Ci_shd,PAR_shd,Ca,ra,rb_shd,Ts,Pre,Ds,...
        Psi_L,Psi_sto_50,Psi_sto_99,...
