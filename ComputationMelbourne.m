...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Coutts A. M., Beringer J., and Tapper N. J. (2007). Characteristics influencing 
% the variability of urban CO2 fluxes in Melbourne, Australia,
% Atmospheric Environment, 41, 51–62, https://doi.org/10.1016/j.atmosenv.2006.08.030
%
% Coutts A. M., Beringer J., and Tapper N. J. (2007). Impact of increasing 
% urban density on local climate: Spatial and temporal variations in the 
% surface energy balance in Melbourne, Australia, 
% Journal of Applied Meteorology and Climatology, 46, 477–493, https://doi.org/10.1175/JAM2462.1
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%% RUN TIME SERIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Load input parameters
load(fullfile('+data_functions', 'Forcing_Data_Melbourne.mat'))

% Assign calculation length
n			=	11376;	% Calculation lenght, e.g. data time series length
m			=	1;		% Usually 1 or length of sensitivity analysis vector

% Assign file names
Name_Site	=	'Melbourne';	% Name chosen for "data_functions\Data_UEHM_site_Name.m" 
								% and "data_functions\UEHMForcingData_Name.m"
NameOutput	=	'Melbourne_98';	% Name under which the calculation will be saved
...
MeteoDataPreston_h.Windspeed(MeteoDataPreston_h.Windspeed(1:n,:)==0) = 0.01;	% Wind speed cannot be 0 otherwise the resistance function fails

% The here shown example includes some unit conversion to fit the input
% data series to the above specified units. Please adjust according to your
% data input units.
MeteoDataRaw	=	struct('LWR_in',MeteoDataPreston_h.LWRin(1:n,:),'SAB1_in',MeteoDataPreston_h.SAB1(1:n,:),...
					'SAB2_in',MeteoDataPreston_h.SAB2(1:n,:),'SAD1_in',MeteoDataPreston_h.SAD1(1:n,:),...
					'SAD2_in',MeteoDataPreston_h.SAD2(1:n,:),'T_atm',MeteoDataPreston_h.Temperature(1:n,:)+273.15,...
					'windspeed_u',MeteoDataPreston_h.Windspeed(1:n,:),'pressure_atm',MeteoDataPreston_h.Pressure(1:n,:),...
					'rain',MeteoDataPreston_h.Precipitation(1:n,:),'rel_humidity',MeteoDataPreston_h.Rel_humidity(1:n,:)./100,'Date',MeteoDataPreston_h.date_time(1:n,:));
