...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[f,fpot]=Infiltration_2(Osat,Ohy,L,alpVG,nVG,Pe,Ks_Zs,O33,SPAR,O,Dz,WIS,cosalp,Pond)
...
[K,P]=soil_functions.Conductivity_Suction(SPAR,Ks_Zs,Osat,Ohy,L,Pe,O33,alpVG,nVG,O);
