...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
phi				=	dms2degrees([1,18,51.46]);		% phi = latitude positive north (degrees)
lambda			=	dms2degrees([103,54,40.31]);	% lambda = longitude positive west (degrees)
theta_canyon	=	deg2rad(78.1); % deg2rad(157)	% theta_canyon = canyon orientation (rad), measured from google maps: 2 main street directions
DeltaGMT		=	8;								% DeltaGMT = difference with Greenwich Meridian Time [h](local apparent time = UTC+8)(Roth et al. 2016)
...
%% Meteorological data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Zatm			=	23.7;					% Atmospheric reference height [m]
